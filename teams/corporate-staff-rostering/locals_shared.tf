locals {
  team_name        = "corporate-staff-rostering"
  ...
  shared_tags = {
    ...
    source-code   = "https://github.com/ministryofjustice/modernisation-platform-ami-builds/tree/main/teams/corporate-staff-rostering"
  }
