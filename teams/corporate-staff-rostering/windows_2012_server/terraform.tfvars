...
region                = "eu-west-2"
ami_name_prefix       = "corporate-staff-rostering"
ami_base_name         = "windows_server_2012"
configuration_version = "6.3.9"
...
parent_image = {
  ...
  arn_resource_id = "mp-windowsserver2012/x.x.x"
}
...
components_custom = [
  {
    path       = "./components/windows_server_2012/windows.yml"
    parameters = []
  }
]
