...
Terraform for managing Delius core AMI pipelines and images.
...
In the relevant development environment, e.g. `delius-core-development`,
...
contains the development account name, e.g. `delius-core-development`.
...
- manually run the `delius-core` pipeline. First plan, and then apply.
