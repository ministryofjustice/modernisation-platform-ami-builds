resource "aws_imagebuilder_image_pipeline" "rhel7" {
  image_recipe_arn                 = aws_imagebuilder_image_recipe.rhel7.arn                 // change to rhel 
  infrastructure_configuration_arn = aws_imagebuilder_infrastructure_configuration.rhel7.arn // change to rhel
  distribution_configuration_arn   = aws_imagebuilder_distribution_configuration.rhel7.arn   // change to rhel
