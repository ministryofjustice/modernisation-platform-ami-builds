locals {
  ...
  windows_pipeline = {
    ...
    pipeline = {
      name     = "Team2-WindowsPipeline"
      schedule = "cron(0 0 * * ? *)"
    }

    recipe = {
      name         = "Team2-WindowsRecipe"
    ...
    infra_config = {
      ...
      name               = "Team2-Windows-InfraConfig"
    ...
    distribution = {
      name     = "Team2-Windows-DistributionConfig"
      region   = "eu-west-2"
      ami_name = "Team2-Windows-{{ imagebuilder:buildDate }}"
    }
