resource "aws_imagebuilder_image_pipeline" "Team2-Linux" {
  image_recipe_arn                 = aws_imagebuilder_image_recipe.Team2-Linux.arn
  infrastructure_configuration_arn = aws_imagebuilder_infrastructure_configuration.Team2-Linux.arn
  distribution_configuration_arn   = aws_imagebuilder_distribution_configuration.Team2-Linux-DistributionConfig.arn
...
resource "aws_imagebuilder_image_recipe" "Team2-Linux" {
...
resource "aws_imagebuilder_infrastructure_configuration" "Team2-Linux" {
...
resource "aws_imagebuilder_distribution_configuration" "Team2-Linux-DistributionConfig" {
