resource "aws_imagebuilder_image_pipeline" "Team1-Windows" {
  image_recipe_arn                 = aws_imagebuilder_image_recipe.Team1-Windows.arn
  infrastructure_configuration_arn = aws_imagebuilder_infrastructure_configuration.Team1-Windows.arn
  distribution_configuration_arn   = aws_imagebuilder_distribution_configuration.Team1-Windows.arn
...
resource "aws_imagebuilder_image_recipe" "Team1-Windows" {
...
resource "aws_imagebuilder_infrastructure_configuration" "Team1-Windows" {
...
resource "aws_imagebuilder_distribution_configuration" "Team1-Windows" {
